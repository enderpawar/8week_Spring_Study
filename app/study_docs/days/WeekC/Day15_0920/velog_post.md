...
### 왜 Repository 호출 하나가 아니라 Service 메서드 전체가 경계인가
...
### `readOnly=true`가 보장하는 것과 보장하지 않는 것
...
### Q1. 롤백 테스트에서 처음에는 왜 UPDATE가 출력되지 않았나
...
### Q2. 직접 flush한 뒤에도 UPDATE가 나오지 않을까
