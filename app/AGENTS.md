...
When the learner says `오늘 학습 시작`, `week N 시작`, `week N 공부 시작`, or otherwise asks to study interactively:

1. Read the roadmap progress checklist and identify the first unchecked required Day.
2. Read `study_docs/복습큐.md` and run due retrieval or +1-day error retests first.
